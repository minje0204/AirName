...
const question = [
  ...
  {
    question:
      '친한 친구의 연인이 클럽을 가다가 당신한테 걸렸네요. 이럴 때가 가장 난감한 상황인데요... 이럴 때 당신은 어떻게 할건가요?',
    answer: { 0: '절대 비밀로한다', 1: '바로 친구한테 연락한다', 2: '잘 모르겠다' },
...

  {
    ...
    answer: { 0: '새로운 길로 간다', 1: '평소가던 길로 간다', 2: '모르겠다' },
...

  {
    ...
    answer: { 0: '한 번 시도해본다', 1: '쳐다도 안본다', 2: '할지 말지 고민 해본다' },
...

  {
    ...
    answer: { 0: '클래식한 연극', 1: '코미디 빅리그', 2: '둘 다 좋다' },
...

  {
    ...
    answer: { 0: '희귀한 이름', 1: '중간 정도', 2: '자주 사용되는 이름' },
    answerKey: 'Rarity'
  },
];
